namespace ParqBaseTests
{
    ...
    public class StreamingTests
    {
        ...
        {
            ParqBaseStatementVisitor.RowGroupSize = 50_000;
            try { Directory.Delete(this.dbPath, true); } catch { }
        }

        private void CreateNums(ParqBase session, int count, int chunk = 500)
        {
        ...
        private static void InsertNums(ParqBase session, int startValue, int count, int chunk = 500)
        {
        ...
        public async Task Stream_AcrossMultipleRowGroups_IsCorrect_IncludingCrossGroupOffset()
        {
            ...
            ParqBaseStatementVisitor.RowGroupSize = 100;
        ...
        {
            var writerSession = new ParqBase();
